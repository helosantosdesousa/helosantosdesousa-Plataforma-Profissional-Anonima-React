...
type PostPageNavigationProp = NativeStackNavigationProp<RootStackParamList, "PostPage">;
type PostPageRouteProp = RouteProp<RootStackParamList, "PostPage">;

type Props = { route: PostPageRouteProp };

export default function PostPage({ route }: Props) {
